        ...
        <div className="rounded-2xl p-8" style={{background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(99,179,237,0.15)'}}>
          ...
          <div className="flex gap-4 items-center mb-4">
            ...
            <div className="text-gray-400">
              × $500 = <span className="text-white font-bold text-xl">${(amount * 500).toLocaleString()}</span>
            </div>
          </div>

          {connected ? (
            <button className="w-full font-bold py-4 rounded-xl text-lg text-black mt-4" style={{background: 'linear-gradient(90deg, #63b3ed, #76e4f7)'}}>
